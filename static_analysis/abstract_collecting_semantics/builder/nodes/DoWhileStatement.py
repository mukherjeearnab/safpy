...
def generate_exit_sets(node: DoWhileStatement, entry_set: apron.Abstract0, exit_sets: Dict[str, apron.Abstract0],
    ...
    if expr_value == True:
        ...
        raise Exception(
            f'Invalid expression value {expr_value} for DoWhile Statement!')
