'''
Class definition for the DoWhileLoopContinue CFG (Extra) node
'''
...
class DoWhileLoopContinue(Node):
    '''
    DoWhileLoopContinue Node
    '''
    ...
    def __init__(self, ast_node: dict,
        ...
        Constructor
        '''
        super(DoWhileLoopContinue, self).__init__(ast_node, entry_node_id, prev_node_id,
                                                  exit_node_id, cfg_metadata)

        # set the basic block type and node type
        self.basic_block_type = BasicBlockTypes.Entry
        self.node_type = 'DoWhileLoopContinue'
